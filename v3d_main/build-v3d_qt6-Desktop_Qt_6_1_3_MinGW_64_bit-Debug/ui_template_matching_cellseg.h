...
public:
    ...
    void setupUi(QDialog *Dialog_TemplateMatchingSegPara)
    {
        ...
        comboBox_Kernel->addItem(QString());
        ...
        doubleSpinBox_stdz->setMinimum(0.500000000000000);
        doubleSpinBox_stdz->setValue(1.500000000000000);
        ...
        doubleSpinBox_stdy->setMinimum(0.500000000000000);
        doubleSpinBox_stdy->setValue(3.000000000000000);
        ...
        doubleSpinBox_stdx->setMinimum(0.500000000000000);
        doubleSpinBox_stdx->setValue(3.000000000000000);
        ...
        doubleSpinBox_pixelval->setMaximum(65535.000000000000000);
        doubleSpinBox_pixelval->setSingleStep(10.000000000000000);
        doubleSpinBox_pixelval->setValue(50.000000000000000);
        ...
        doubleSpinBox_rgnval->setMaximum(65535.000000000000000);
        doubleSpinBox_rgnval->setSingleStep(10.000000000000000);
        doubleSpinBox_rgnval->setValue(40.000000000000000);
        ...
        doubleSpinBox_corrcoef->setMaximum(1.000000000000000);
        doubleSpinBox_corrcoef->setValue(0.500000000000000);
        ...
        doubleSpinBox_rgn_merge_radius->setMaximum(65535.000000000000000);
        doubleSpinBox_rgn_merge_radius->setSingleStep(10.000000000000000);
        doubleSpinBox_rgn_merge_radius->setValue(20.000000000000000);
    ...
    {
        Dialog_TemplateMatchingSegPara->setWindowTitle(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Template matching segmentation parameters", nullptr));
        label->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Channel", nullptr));
        label_3->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Kernel (template)", nullptr));
        comboBox_Kernel->setItemText(0, QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Gaussian", nullptr));

        label_5->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Dimension \n"
"(radius, # pixels)", nullptr));
        label_2->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "x", nullptr));
        label_4->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "y", nullptr));
        label_7->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "z", nullptr));
        label_10->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Standard Deviation", nullptr));
        label_6->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "x", nullptr));
        label_8->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "y", nullptr));
        label_9->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "z", nullptr));
        groupBox->setTitle(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Thresholds", nullptr));
        label_11->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Pixel value >=", nullptr));
        label_12->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Local region pixel \n"
"mean value >=", nullptr));
        label_13->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Correlation >=", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Other parameters", nullptr));
        label_14->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "region merge radius", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "Cancel", nullptr));
        pushButton_ok->setText(QCoreApplication::translate("Dialog_TemplateMatchingSegPara", "OK", nullptr));
    } // retranslateUi
