...
public:
    ...
    void setupUi(QDialog *Dialog_ImageCrop_BBox)
    {
        ...
        QObject::connect(okButton, &QPushButton::clicked, Dialog_ImageCrop_BBox, qOverload<>(&QDialog::accept));
        QObject::connect(cancelButton, &QPushButton::clicked, Dialog_ImageCrop_BBox, qOverload<>(&QDialog::reject));
    ...
    {
        Dialog_ImageCrop_BBox->setWindowTitle(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Image Crop Options", nullptr));
        label_5->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Min", nullptr));
        label_6->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Max", nullptr));
        label_2->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "X :", nullptr));
        label_3->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Y :", nullptr));
        label_4->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Z :", nullptr));
        label_7->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Color channel:", nullptr));
        label->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Landmarks options : ", nullptr));
        landmarksBox->setItemText(0, QCoreApplication::translate("Dialog_ImageCrop_BBox", "Subtract min and delete landmarks outside the bounding box", nullptr));
        landmarksBox->setItemText(1, QCoreApplication::translate("Dialog_ImageCrop_BBox", "Subtract min and keep landmarks outside the bounding box", nullptr));
        landmarksBox->setItemText(2, QCoreApplication::translate("Dialog_ImageCrop_BBox", "Do not alter landmark coordinates", nullptr));

        cancelButton->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "Cancel", nullptr));
        okButton->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "OK", nullptr));
        infolabel->setText(QCoreApplication::translate("Dialog_ImageCrop_BBox", "info: Crop Image Options", nullptr));
    } // retranslateUi
