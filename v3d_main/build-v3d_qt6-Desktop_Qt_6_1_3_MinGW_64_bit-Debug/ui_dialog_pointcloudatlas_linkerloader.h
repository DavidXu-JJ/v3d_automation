...
public:
    ...
    {
        Dialog_pointcloudatlas_linkerloader->setWindowTitle(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Pointcloud atlas linker file editor", nullptr));
        label_classname->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Signal name (e.g. gene name PS1)", nullptr));
        label_info_num_apo_files->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "# of valid pointcloud files", nullptr));
        label_sigclass->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Signal channel folder", nullptr));
        pushButton_sig_folder->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Folder ...", nullptr));
        label_refclass->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Reference channel folder", nullptr));
        pushButton_ref_folder->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Folder ...", nullptr));
        label_output_file->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Output pointcloud file of this signal", nullptr));
        pushButton_output_file->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "File...", nullptr));
        pushButton_common_ref_file->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "File...", nullptr));
        label_common_targetref->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Common target pointcloud reference file", nullptr));
        label_common_referencemarker->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Common reference (e.g. gene name EVE)", nullptr));
        label_info_existing_classes->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Existing signals are: ", nullptr));
        label->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Tip: If any texts above become red color, you need to enter valid file/folder info. \n"
" If the common target pointcloud ref file is left empty, then define target automatically.", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Cancel", nullptr));
        pushButton_finish->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Finish", nullptr));
        pushButton_addanother->setText(QCoreApplication::translate("Dialog_pointcloudatlas_linkerloader", "Add a new signal", nullptr));
    } // retranslateUi
