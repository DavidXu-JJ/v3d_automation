...
public:
    ...
    {
        Dialog_vano_linkerloader->setWindowTitle(QCoreApplication::translate("Dialog_vano_linkerloader", "Linker file editor", nullptr));
        label_rawimg->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Raw Image", nullptr));
        pushButton_rawimg->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "File ...", nullptr));
        label_maskimg->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Mask Image", nullptr));
        pushButton_maskimg->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "File ...", nullptr));
        label_apofile->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Annotation file", nullptr));
        pushButton_apofile->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "File ...", nullptr));
        label->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Tip: if any texts above become red color, the files do NOT exist!", nullptr));
        pushButton_cancel->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Cancel", nullptr));
        pushButton_loaddata->setText(QCoreApplication::translate("Dialog_vano_linkerloader", "Load data", nullptr));
    } // retranslateUi
